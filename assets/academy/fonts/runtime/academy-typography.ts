...
export const ACADEMY_TYPOGRAPHY_RECIPES: Readonly<Record<AcademyTypographyRole, AcademyTypographyRecipe>> = {
  ...
  'game-title': {
    recipeId: 'game-title-on-dark', family: 'Cinzel', weight: 800,
    fallbackStack: SERIF_FALLBACK, sizeRangePx: [30, 50], lineHeight: 1.1,
    letterSpacing: '0.02em', color: '#f1dfae', stroke: '#39231a', strokeThickness: 1,
    shadow: { color: '#241326', offsetX: 6, offsetY: 6, blur: 0, fill: true }, align: 'center',
  },
  'panel-heading': {
  ...
  'result-state': {
    recipeId: 'result-on-teal-frame', family: 'Cinzel', weight: 800,
    fallbackStack: SERIF_FALLBACK, sizeRangePx: [24, 39], lineHeight: 1.08,
    letterSpacing: '.005em', color: '#3b2119', stroke: '#c78d48', strokeThickness: 1,
    shadow: { color: 'rgba(55,28,35,0.34)', offsetX: 3, offsetY: 3, blur: 0, fill: true }, align: 'center',
  },
  'dialogue-title': {
...
export const ACADEMY_RUNTIME_FONT_FACES: readonly AcademyFontFaceDefinition[] = [
  ...
  { family: 'Cinzel', weight: 800, descriptor: '800 16px "Cinzel"', sourcePath: '../source/google-fonts/cinzel/Cinzel[wght].ttf' },
