...
(async () => {
  ...
  await page.screenshot({ path: captureRun.file('stills', '02-degraded.png') });
  ...
  await page.screenshot({ path: captureRun.file('stills', '03-recovered.png') });
  ...
  await page.screenshot({ path: captureRun.file('stills', '04-defeat.png') });
  ...
  finalizeCaptureRun(captureRun, {
    captureScript: 'games/tier-1/07-pet-campfire/capture.cjs',
