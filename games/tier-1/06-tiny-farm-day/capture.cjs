...
(async () => {
  ...
  await page.screenshot({ path: captureRun.file('stills', '01_boot.png') });

  // 2. Planting
  console.log('Planting Plot 0');
  await page.click('#btn-interact'); // Plants Plot 0
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '02_planted.png') });

  // 3. Watering
  console.log('Watering Plot 0');
  await page.click('#btn-interact'); // Waters Plot 0
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '03_watered.png') });
  ...
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '04_plot1_planted.png') });
  ...
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '05_plot0_grown.png') });
  ...
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '06_harvest_plot0.png') });
  ...
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '07_all_harvested.png') });

  // 7. Sell crops
  console.log('Sell crops');
  await page.click('#btn-sell');
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '08_sell.png') });
  ...
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '09_invalid_action.png') });

  // 9. Buy Upgrade
  console.log('Buy Upgrade');
  await page.click('#btn-upgrade');
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '10_upgrade.png') });

  // 10. End Day Victory
  console.log('End Day');
  await page.click('#btn-end');
  await delay(200);
  await page.screenshot({ path: captureRun.file('stills', '11_victory.png') });

  await browser.close();
  finalizeCaptureRun(captureRun, {
    captureScript: 'games/tier-1/06-tiny-farm-day/capture.cjs',
