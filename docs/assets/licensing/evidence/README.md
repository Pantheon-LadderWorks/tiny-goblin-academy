...
- `test_asset_exposure_inventory.py` protects reference-category separation, committed-audit determinism, proportional first-party AI classification, and the fail-closed global tracked-media sentinel.
